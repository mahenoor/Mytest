...
if (!empty($_GET['id'])) {
    ...
    $previousStudentData['studentName'] = $studentData['studentName'];
    $previousStudentData['Department'] = $studentData['Department'];
    $previousStudentData['Gender'] = $studentData['Gender'];
    $previousStudentData['Roll_no'] = $studentData['Roll_no'];
    $previousStudentData['Subject1'] = $studentData['Subject1'];
    $previousStudentData['Subject2'] = $studentData['Subject2'];
	$previousStudentData['Subject3'] = $studentData['Subject3'];
}
if($_POST) {
