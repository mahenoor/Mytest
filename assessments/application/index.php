...
if (!empty($_GET['student_leave_id'])) {

    $responseOfDelete = $crudObj->deleteRecord($_GET['student_leave_id']);
}
...
?>
        ...
        <a href="index.php?id=<?php echo $studentData['id'] ?>&student_leave_id=<?php echo $studentData['std_leave_id'] ?>">Delete</a>
